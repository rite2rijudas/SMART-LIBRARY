...
public class Books {
   ...
   public Books(int bId, String bName, String authorName, String publisherName,String edition, String category, String location, String time) {
	   this.bId=bId;
	   this.bName=bName;
  ...
  // function to get all book list 
   ...
   public ArrayList<Books> getAllPosts() {
		   ...
		   try {
			 ...
			 while (rst.next())
			 {
				 ...
				 String dateTime = rst.getString("bTime");
   ...
   public boolean addBook(Books book) {
	   ...
	   try {   
			Connection connect = connectSql.getConnection(); // calling getConnect function from Connector class(user defined)
		String cmd= "insert into books(bName, authorName, publisherName, edition, category, location,bTime) values(?,?,?,?,?,?,?)";
